        ...
        <div class="clear_percent">
            ...
            <div class="jt_panel" style=" width:69%;float:right;">
                ...
                <div class="tab_1_inner float_left float_left" >
                    ...
                    <div class="width_in3 float_left indent_input_tp">
                        <input type="text" class="input_1 float_left  " data-name="salesorder_date" value="<?php echo isset($query['salesorder_date']) && is_object($query['salesorder_date']) ? date('d M, Y', $query['salesorder_date']->sec) : '' ?>" readonly="readonly">
                    </div>
                    <p class="clear">
                ...
                <div class="tab_1_inner float_left float_left" >
                    ...
                    <div class="width_in3 float_left indent_input_tp" >
                        <input type="text" class="input_1 float_left  " value="<?php echo isset($query['status']) ? $query['status'] : '' ?>" data-name="status"  readonly="readonly">
                    </div>
                </div>
            </div>
        </div>
