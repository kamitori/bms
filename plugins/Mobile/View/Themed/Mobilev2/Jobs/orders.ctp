...
?>
    <li id="list-<?php echo $value['_id'] ?>" class="ui-li-static ui-body-inherit"  data-role="collapsible" data-role="collapsible" data-collapsed-icon="arrow-d" data-expanded-icon="arrow-u" data-iconpos="right" data-inset="false">
        <h2>
            ...
            <div class="ui-block-c" style="width:5%"><?php echo $value['sum_sub_total'];?></div>
        </h2>
        <ul data-role="listview" data-theme="b">
            ...
            <li>
                <div class="ui-block-a" style="width:30%"><b>Date in</b></div>
                <div class="ui-block-b" style="width:70%">
                    <?php echo $value['salesorder_date']; ?>
                </div>
            </li>
            <li>
            ...
            <li>
                <div class="ui-block-a" style="width:30%"><b>Assign to</b></div>
...
$(function(){
    $("#delete_button").click(function(){
        ...
        $.ajax({
        url : "<?php echo M_URL.'/jobs/orders_delete/' ?>"+ids,
    ...
    $("#find-record").html('<?php echo $total_amount; ?>').attr({"href":"javascript:void(0)","onclick":"return false;","title":"Sum Amount"});
    $("#entry-record").html('<?php echo $total_tax; ?>').attr({"href":"javascript:void(0)","onclick":"return false;","title":"Sum Tax"});
    $("#list-record").html('<?php echo $total_sub_total; ?>').attr({"href":"javascript:void(0)","onclick":"return false;","title":"Sum Sub Total"});
    $("#delete-record").html('<?php echo "Entry"; ?>').attr({"href":"http://jobtraq.local.com/mobile/jobs/entry","id":"entry-record", "class":"ui-link ui-btn","data-ajax":"false"});
