    ...
    <div class="jbcont">
        <div class="jt_module_title float_left jt_t_left">
            <h1>
                ...
                <span id="md_name">
                    <?php if(isset($subdatas[$salesorderline]['products_name'])) echo $subdatas[$salesorderline]['products_name'];?>
                </span>
                <input type="hidden" id="costing_product_key" value="<?php echo $subdatas[$salesorderline]['key']; ?>" />
             </h1>
        </div>
