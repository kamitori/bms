<div class="logo float_left">
    ...
    <div class="title_top_ctrl float_left">
        ...
        <span>Request <?php echo $entry_menu['page'];?> of <?php if(isset($entry_menu['search'])) echo $entry_menu['search'];?> find requests. Presss 'Continue' or 'Enter' key toperform find.</span>
    </div>
</div>