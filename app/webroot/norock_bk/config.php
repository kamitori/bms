...
$MONGO["servers"][$i]["mongo_timeout"] = 300000;//mongo connection timeout
$MONGO["servers"][$i]["mongo_db"] = "admin";//default mongo db to connect, works only if mongo_auth=false
$MONGO["servers"][$i]["mongo_user"] = "sysadmin";//mongo authentication user name, works only if mongo_auth=false
$MONGO["servers"][$i]["mongo_pass"] = "serCurity!2017";//mongo authentication password, works only if mongo_auth=false
...
$MONGO["servers"][$i]["control_users"]["bmsadmin"] = "banhmicanada";//one of control users ["USERNAME"]=PASSWORD, works only if mongo_auth=false
