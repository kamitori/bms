    ...
    <li id="list-<?php echo $value['_id'] ?>" <?php if(isset($value['option_for']) && $value['_id']!='Extra_Row') echo 'style="width: 89%; margin-left: 11%;" data-theme="b" data-option-for="'.$value['option_for'].'"'; ?> class="<?php if(!isset($value['option_for']) || $value['_id']=='Extra_Row') echo 'parent-line'; ?> list-line-item ui-li-static ui-body-inherit"  data-role="collapsible" data-role="collapsible" data-collapsed-icon="arrow-d" data-expanded-icon="arrow-u" data-iconpos="right" data-inset="false">
        ...
        <ul data-role="listview" data-theme="b">
            ...
            <li>
                ...
                <div class="ui-block-b" style="width:70%">
                    <input type="text" name="unit_price" class="unit_price" id="unit_price_<?php echo $value['_id'] ?>" <?php if(isset($value['xlock']['unit_price'])) echo 'readonly="readonly"'; ?> data-theme="a" value="<?php echo isset($value['unit_price']) ? $value['unit_price'] : ''; ?>" />
                </div>
            </li>
            <?php } ?>
            ...
            <li>
                ...
                <div class="ui-block-b" style="width:70%">
                    <span id="adj_qty_<?php echo $value['_id']; ?>"><?php echo isset($value['adj_qty'])?$value['adj_qty']:''; ?></span>
                </div>
            </li>
            <?php } ?>
...
$(function(){
    ...
    $("#delete-record").text("Entry").attr("href","<?php echo M_URL.'/'.$controller.'/entry/'; ?>").attr("data-ajax","false");
})
</script>