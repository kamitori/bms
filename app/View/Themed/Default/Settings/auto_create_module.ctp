...
<div class="tab_1 full_width">
    ...
    <div id="system_email_content" style="height: 473px;overflow-y: auto">
        <div class="jt_box" style=" width:100%;">
            ...
            <div class="jt_box_line">
                ...
                <div class="jt_box_field " style=" width:71%"><input id="module_submit" class="jt_confirms_window_ok" style="float: left;margin-top: 20px;" type='button' name='ok' value='OK' /></div>
