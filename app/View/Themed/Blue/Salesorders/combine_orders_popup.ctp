        ...
        <tbody>
            ...
            foreach ($arr_salesorders as $value) {
                ...
                <tr class="jt_line_<?php if ($i == 1) { ?>black<?php } else { ?>light<?php } ?>" id="tr_<?php echo $value['_id']; ?>" onclick="$('input[type=checkbox]',this).click()">
                    ...
                    <td align="center"><?php if(isset($value['salesorder_date']))echo $this->Common->format_date($value['salesorder_date']->sec); ?>&nbsp;</td>
                    ...
                    <td align="left"><?php if(isset($value['status']))echo $value['status']; ?>&nbsp;</td>
                </tr>
            <?php } ?>
...
$(function(){
    ...
    $("#submit_batch<?php echo $key ?>").click(function(){
        ...
        $.ajax({
            url: "<?php echo URL.'/salesorders/combine_orders' ?>",
            data: data,
            type: "POST",
