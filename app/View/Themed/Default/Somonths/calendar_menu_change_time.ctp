    ...
    <div class="company_title float_left">
        <div class="clear dent_x">
            <ul id="calendar_day_week_month" class="control_topleft float_left">
                ...
                <li><a href="javascript:void(0)" onclick="salesorders_click_calendar_active(this);scheduler.setCurrentView(scheduler._date, 'day');calendar_get_date();">Day</a></li>
                <li><a href="javascript:void(0)" onclick="salesorders_click_calendar_active(this);scheduler.setCurrentView(scheduler._date, 'week');calendar_get_date();" class="active">Week</a></li>
                <li><a href="javascript:void(0)" onclick="salesorders_click_calendar_active(this);scheduler.setCurrentView(scheduler._date, 'month');calendar_get_date();">Month</a></li>
...
<input type="hidden" id="salesorders_calendar_load_finish" value="1">
<input type="hidden" id="salesorders_calendar_date_from" value="">
<input type="hidden" id="salesorders_calendar_date_to" value="">

<script type="text/javascript">
function salesorders_click_calendar_active(jtobject){
