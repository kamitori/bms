...
<div class="tab_1 half_width" style="width:45%;margin:5% auto;">
        ...
        <form id="form_purchaseorders" method="POST" action="<?php echo URL.'/'.$controller.'/customer_report/detailed'; ?>">
        <div class="tab_2_inner">
            ...
            <p></p>
            <p class="clear">
                <span class="label_1 float_left minw_lab2">Supllier Contact</span>
                </p>
                <div class="indent_new width_in float_left" style="width:61%">
                    <?php
    ...
    $(function(){
        ...
        $('#ContinueButton').click(function(){
            if(check_Empty())
                ...
                $.ajax({
                    url: '<?php echo URL; ?>/purchaseorders/customer_report/detailed',
                    type: 'POST',
                    data: $('#form_purchaseorders').serialize(),
                    success : function(result){
                        if(result=='empty')
                            alerts('Message','No record!');
                        else
                            $('#form_purchaseorders').submit();
                    }
                });
            }
        });
