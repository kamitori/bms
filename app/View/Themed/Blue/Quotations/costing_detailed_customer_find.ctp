...
<div class="tab_1 half_width" style="width:45%;margin:5% auto;">
        ...
        <form id="form_quotation" method="POST">
            ...
            <p class="clear">
                ...
                <div class="width_in3a float_left indent_input_tp" style="margin-top:1.7%">
                    <label class="m_check2">
                        <input type="checkbox" class="custoer-employee" name="is_not_cancel" id="is_not_cancel" value="0">
    ...
    $(function(){
        ...
        $('#ContinueButton').click(function(){
            ...
            else
            {
                ...
                $.ajax({
                    url: '<?php echo URL; ?>/quotations/check_exist_customer',
                    type: 'POST',
