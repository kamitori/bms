...
<div class="tab_1 full_width">
	...
	<div class="new_select_black" style="width:30%; float:right; margin-right:8px;">
	    ...
	    <div class="new_select_black_center" style="width:94%;">
	        <input type="text" id="language_list" combobox_blank="1" value="<?php if(isset($arr_language[$arr_language_value])) echo $arr_language[$arr_language_value];?>" />
...
<!-- 		<span>
	...
	<ul class="ul_mag clear bg3">
		...
		if(isset($arr_setting['option']) && !empty($arr_setting['option'])) {
		...
		?>
			<li class="hg_padd center_text" style="width:24%">Name <!-- <em style="font-weight: normal; font-size:11px">(allow to edit)</em> --></li>
			<li class="hg_padd center_text" style="width:24%">Value</li>
			<?php if( isset($value['color']) || $arr_setting['setting_value'] == 'tasks_status' ){ ?>
				<li class="hg_padd center_text" style="width:8%">Color</li>
			<?php } ?>
			<?php if($arr_setting['setting_value'] == 'product_category' ){ ?>
				<li class="hg_padd center_text" style="width:6%">Pubblic</li>
				<li class="hg_padd center_text" style="width:15%">Hidden on website</li>
				<li class="hg_padd center_text" style="width:15%">Hidden on POS</li>
			<?php } ?>
	...
	<div class="container_same_category" style="height: 449px;overflow-y: auto">
		...
		uasort($arr_setting['option'], function($a ,$b){
		...
		foreach ($arr_setting['option'] as $key => $value) {
			...
			<ul class="ul_mag clear bg<?php echo $i; ?>">
				...
				<li class="hg_padd center_text" style="width:24%">
					<?php
				...
				<li class="hg_padd center_text" style="width:6%">
					<input type="hidden" name="Setting[pubblic]" value="0" />
					<input type="checkbox" name="Setting[pubblic]" value="1" <?php if (isset($value['pubblic']) && $value['pubblic'] == 1) echo 'checked'; ?> />
				</li>
				<li class="hg_padd center_text" style="width:15%">
					<input type="hidden" name="Setting[hidden_on_website]" value="0" />
					<input type="checkbox" name="Setting[hidden_on_website]" value="1" <?php if (isset($value['hidden_on_website']) && $value['hidden_on_website'] == 1) echo 'checked'; ?> />
				</li>
				<li class="hg_padd center_text" style="width:15%">
					<input type="hidden" name="Setting[hidden_on_pos]" value="0" />
					<input type="checkbox" name="Setting[hidden_on_pos]" value="1" <?php if (isset($value['hidden_on_pos']) && $value['hidden_on_pos'] == 1) echo 'checked'; ?> />
				</li>
				<?php } ?>
