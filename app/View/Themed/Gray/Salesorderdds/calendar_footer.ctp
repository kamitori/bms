            ...
            <div class="status1 float_left">
                ...
                <span class="block_sear bl_t2 float_right">
                    ...
                    <div class="box_inner_search float_left">
                        ...
                        <?php echo $this->Form->input('Salesorder.status_filter', array(
                                'options' => $arr_status,
                                'class' => 'sele3_fix_s float_left',
                                'onchange' => 'salesorderdds_calendar_onchange_status()',
                                'empty' => '   '
                        )); ?>

                        <span class="icon_show"></span>
                        <span class="icon_close" onclick="$('#SalesorderStatusFilter').val('');salesorderdds_calendar_onchange_status();"></span>
                    </div>
                </span>
            </div>
        </form>
