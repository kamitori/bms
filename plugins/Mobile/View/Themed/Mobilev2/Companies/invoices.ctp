...
?>
    <li id="list-<?php echo $value['_id'] ?>" class="ui-li-static ui-body-inherit"  data-role="collapsible" data-role="collapsible" data-collapsed-icon="arrow-d" data-expanded-icon="arrow-u" data-iconpos="right" data-inset="false">
        <h2>
            ...
            <div class="ui-block-b" style="width:60%"><?php echo $value['customer_po_no'];?></div>
        </h2>
        <ul data-role="listview" data-theme="b">
            ...
            <li>
                <div class="ui-block-a" style="width:30%"><b>Total</b></div>
                <div class="ui-block-b ui-checkbox" style="width:70%">
                    <?php echo $value['sum_amount']; ?>
                </div>
            </li>
            <li>
                <div class="ui-block-a" style="width:30%"><b>Receipts</b></div>
                <div class="ui-block-b" style="width:70%">
                    <?php echo $value['total_receipt']; ?>
                </div>
            </li>
            <li>
                <div class="ui-block-a" style="width:30%"><b>Balance</b></div>
                <div class="ui-block-b" style="width:70%">
...
$(function(){
    $("#delete_button").click(function(){
        ...
        $.ajax({
        url : "<?php echo M_URL.'/companies/invoices_delete/' ?>"+ids,
