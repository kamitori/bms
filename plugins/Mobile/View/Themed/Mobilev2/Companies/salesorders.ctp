    ...
    <li id="list-<?php echo $value['_id'] ?>" class="ui-li-static ui-body-inherit"  data-role="collapsible" data-role="collapsible" data-collapsed-icon="arrow-d" data-expanded-icon="arrow-u" data-iconpos="right" data-inset="false">
        ...
        <ul data-role="listview" data-theme="b">
            ...
            <li>
                ...
                <div class="ui-block-b" style="width:70%">
                    <?php echo $value['sales_order_type']; ?>
                </div>
            </li>
            <li>
...
$(function(){
    $("#delete_button").click(function(){
        ...
        $.ajax({
        url : "<?php echo M_URL.'/companies/salesorders_delete/' ?>"+ids,
    ...
    $("#list-record").text('<?php echo number_format($sum_total,2); ?>').attr(attrObj).css("text-align","right").attr("id","sum-amount");
    attrObj["title"] = "Sum Tax";
    $("#entry-record").text('<?php echo $total_order; ?>').attr(attrObj).css("text-align","right").attr("id","sum-tax");
})
</script>