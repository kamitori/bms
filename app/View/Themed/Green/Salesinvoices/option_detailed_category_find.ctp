...
<div class="tab_1 half_width" style="width:40%;margin:0 auto;">
        ...
        <form id="product_find" action="<?php echo URL;?>/salesinvoices/product_report/category_detailed" method="POST">
        <div class="tab_2_inner">
            ...
            <p class="clear">
                ...
                <div class="indent_new width_in float_left" style="width:25%">
                    <input name="sell_price_from" class="input_4 float_left validate " style="padding:0 3%;" type="text" id="sell_price">
                </div>
                <span class="float_left" style="margin-top:2%">To</span>
                    <input name="sell_price_to" class="input_4 float_left validate " style="padding: .3% 1%;width: 30%;" type="text" id="sell_price">
                <p class="clear"></p>
            <p></p>
            <p class="clear"></p>
        </div>
        <div>
        <input type="hidden" name="report_type" id="report_type" value="category_detailed" />
...
<script type="text/javascript">
    $(function(){
        ...
        $('#ContinueButton').click(function(){
            if(check_Empty())
                ...
                $.ajax({
                    url: '<?php echo URL; ?>/salesinvoices/product_report/category_detailed',
                    type: 'POST',
    ...
    function after_choose_products(_id,product_name,keys){
        ...
        $('#'+keys+'_id').val(_id);
        $.get('<?php echo URL; ?>/salesinvoices/get_cate_product/'+product_info.category,function(result) {
            //console.log(result);
            $('#category').val(result);
        });
