...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#bt_add_emergency").click(function(){
			...
			save_option('emergency',datas,'',1,'personal','add');
			save_to_other_module('communications',datas,'',function(ret){
			});
		});

		$("#container_emergency").delegate(".rowedit input,.rowedit select","change",function(){
			//nhan id
			//alert('avc');
			...
			save_option('emergency',datas,ids,0,'personal','update',function(){});
		});
