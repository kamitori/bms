...
<div class="tab_1 half_width" style="width:40%;margin:0 auto;">
        ...
        <form id="product_find" action="<?php echo URL;?>/quotations/product_report/category_detailed" method="POST">
    ...
    $(function(){
        ...
        $('#ContinueButton').click(function(){
            if(check_Empty())
                ...
                $.ajax({
                    url: '<?php echo URL; ?>/quotations/product_report/category_detailed',
                    type: 'POST',
