	...
	<table cellpadding="2" cellspacing="0" style="width:100%; margin: 0px auto">
		<tr>
			...
			<td width="25%" valign="top" align="right">
					<div style=" text-align:right; font-size:20px; font-weight:bold; color: #919295; border-bottom: 1px solid #cbcbcb;width:30%;"><span style="color:#b32017">S</span>ales Invoice</div>
