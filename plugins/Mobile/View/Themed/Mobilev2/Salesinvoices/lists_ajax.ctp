<?php foreach ($arr_salesinvoices as $value): ?>
    <li id="list-<?php echo $value['_id'] ?>" class="ui-li-static ui-body-inherit"  data-role="collapsible" data-role="collapsible" data-collapsed-icon="arrow-d" data-expanded-icon="arrow-u" data-iconpos="right" data-inset="false">
        ...
        <ul data-role="listview" data-theme="b">
            <li>
                <div class="ui-block-a" style="width: 40%"><b>Salesinvoice code</b></div>
            ...
            <li>
                ...
                <div class="ui-block-b" style="width:60%">
                    <?php if (isset($value['salesinvoice_type']) && isset($arr_salesinvoices_type[$value['salesinvoice_type']])) echo $arr_salesinvoices_type[$value['salesinvoice_type']]; ?>
                </div>
            </li>
            ...
            <li>
                ...
                <div class="ui-block-b" style="width:60%">
                    <?php echo isset($value['salesinvoice_status'])?$value['salesinvoice_status']:'';?>
                </div>
            </li>
