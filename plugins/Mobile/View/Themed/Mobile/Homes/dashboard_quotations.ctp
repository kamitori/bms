...
<ul class="ul_mag clear bg<?php echo $i; ?>" onclick="dashboard_run('quotations', '<?php echo $value['_id']; ?>')" title="View detail">
	...
	<li class="hg_padd " style="width:33%"><?php echo $value['company_name']; ?></li>
	<li class="hg_padd right_txt" style="width:27%"><?php if(isset($one_record))echo number_format($one_record,2); ?></li>
...
$(function(){
	$("#quotations_total").val("<?php echo number_format($total_box, 2); ?>");
});
</script>