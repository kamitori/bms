...
<div class="tab_1 half_width" style="width:45%;margin:5% auto;">
        ...
        <form id="form_salesorders" method="POST" action="<?php echo URL.'/'.$controller.'/customer_report/'.$report_type; ?>">
    ...
    $(function(){
        ...
        $('#ContinueButton').click(function(){
            if(check_Empty())
                ...
                $.ajax({
                    url: '<?php echo URL; ?>/salesorders/customer_report/<?php echo $report_type; ?>',
                    type: 'POST',
                    data: $('#form_salesorders').serialize(),
                    success : function(result){
                        if(result=='empty')
                            alerts('Message','No record!');
                        else
                            $('#form_salesorders').submit();
                    }
                });
            }
        });
