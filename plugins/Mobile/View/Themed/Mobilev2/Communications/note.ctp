<form class="<?php echo $controller; ?>_form_auto_save" id="form_company_<?php //echo $this->data['Company']['_id']; ?>">
    ...
    <div class="ui-field-contain">
        <label class="field-title" for="CommunicationContactFrom"><?php echo __('By'); ?></label>
        <?php 
    ...
    <div class="ui-field-contain">
        <label class="field-title" for="CommunicationContactName"><?php echo __('Contact'); ?></label>
        <?php
    ...
    <div class="ui-field-contain">
        <label class="field-title" for="CommunicationDate"><?php echo __('Time'); ?></label>
        <?php echo $this->Form->input('Communication.type', array(
                'readonly'  => 'true',
        )); ?>
    </div>

    <div data-role="fieldcontain">
        <label for="textarea">Note text</label>
