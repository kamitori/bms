...
<ul class="ul_mag clear bg<?php echo $i; ?>" onclick="dashboard_run('jobs', '<?php echo $value['_id']; ?>')" title="View detail">
	...
	<li class="hg_padd " style="width:60%"><?php if(isset($value['no']))echo $value['no']; ?><?php if(isset($value['company_name']))echo '-'.$value['company_name']; ?></li>
	<li class="hg_padd center_txt no_border" style="width:5%">
		<?php
