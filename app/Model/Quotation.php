...
class Quotation extends AppModel {
	...
	public function add($field='',$values=''){
		...
		if($this->arrfield()){
			...
			$this->arr_temp['payment_due_date'] = $this->arr_temp['quotation_date'] = new MongoDate(strtotime(date('Y-m-d')));
			$this->arr_temp['invoice_address'][0]['invoice_country'] = 'Canada';
			$this->arr_temp['invoice_address'][0]['invoice_country_id'] = 'CA';
			$this->arr_temp['invoice_address'][0]['deleted'] = false;
			$this->arr_temp['shipping_address'][0]['shipping_country'] = 'Canada';
			$this->arr_temp['shipping_address'][0]['shipping_country_id'] = 'CA';
