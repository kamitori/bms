...
<ul class="ul_mag clear bg<?php echo $i; ?>" onclick="dashboard_run('tasks', '<?php echo $value['_id']; ?>')" title="View detail">
	...
	<li class="hg_padd center_txt" style="width:18%"><?php if(isset($value['work_end']))echo date('H:i', $value['work_end']->sec); ?></li>
	<li class="hg_padd" style="width:38%">
		<?php $color = '';
			...
			// }
		?>
		<span style="color:<?php echo $color; ?>"><?php echo $value['name']; ?></span>
	</li>
	<li class="hg_padd center_txt no_border" style="width:13.7%">
		<?php
