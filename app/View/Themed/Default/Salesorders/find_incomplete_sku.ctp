...
<div class="tab_1 half_width" style="width:40%;margin:6% auto;">
    ...
    <form id="product_find" action="<?php echo URL;?>/salesorders/production_report" method="POST">
        <div class="tab_2_inner">
            ...
            <div class="indent_new width_in float_left" style="width:61%">
                <input name="product_sku" class="input_4 float_left" type="text" id="product_sku">
            </div>
            <p></p>
            <p></p>
            <p class="clear">
    ...
    $(function() {
        ...
        $('#ContinueButton').click(function() {
            if (check_Empty())
                ...
                $.ajax({
                    url: '<?php echo URL; ?>/salesorders/production_report',
                    type: 'POST',
