            ...
            <div class="status1 float_left">
                ...
                <span class="block_sear bl_t2 float_right">
                    ...
                    <div class="box_inner_search float_left">
                        ...
                        <?php echo $this->Form->input('Job.status_filter', array(
                                'options' => $arr_jobs_status,
                                'class' => 'sele3_fix_s float_left',
                                'onchange' => 'jobs_calendar_onchange_status()',
                                'empty' => '   '
                        )); ?>

                        <span class="icon_show"></span>
                        <span class="icon_close" onclick="$('#JobStatusFilter').val('');jobs_calendar_onchange_status();"></span>
                    </div>
                </span>
            </div>
        </form>
