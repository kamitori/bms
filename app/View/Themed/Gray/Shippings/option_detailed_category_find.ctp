...
<div class="tab_1 half_width" style="width:40%;margin:0 auto 100px;">
        ...
        <div class="tab_2_inner">
            <form id="shipping_product" action="<?php echo URL; ?>/shippings/product_report/category_detailed" method="POST">
            <p class="clear">
    ...
    $(function(){
        ...
        $('#ContinueButton').click(function(){
            if(check_Empty==true)
                ...
                $.ajax({
                    url: '<?php echo URL; ?>/shippings/product_report/category_detailed',
                    type: 'POST',
