...
<div class="tab_1 full_width">
	<span class="title_block bo_ra1">
		...
		<?php echo $this->Js->link( '<span class="icon_down_tl top_f"></span>', '/contacts/products_price_break_add/'.$contact_id.'/'.$key,
			array(
			...
			<ul class="ul_mag clear bg<?php echo $i; ?>" id="company_product_price_break_<?php echo $price_break_key; ?>">
				<li class="hg_padd" style="width:24%">
					<?php echo $this->Form->input('range_from', array(
							...
							'onchange' => 'contact_product_pricebreak_save(this)',
				...
				<li class="hg_padd" style="width:6%">
					<div class="middle_check">
						<a title="Delete link" href="javascript:void(0)" onclick="contact_pricebreak_delete(<?php echo $price_break_key; ?>)">
