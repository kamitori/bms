...
<div class="tab_1 half_width" style="width:40%;margin:0 auto;">
        ...
        <form id="product_find" action="<?php echo URL;?>/salesinvoices/product_report/summary" method="POST">
        ...
        <div>
        <input type="hidden" name="report_type" id="report_type" value="summary" />
