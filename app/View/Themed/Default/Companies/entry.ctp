        ...
        <form class="form_<?php echo $controller;?>" action="" method="post" class="float_left">
            <div class="clear_percent">
                ...
                <?php echo $this->element('panel_group',array('datas'=>array('panel_2'),'css'=>'panel_2')); ?>
                 ...
                 <!--Elememt Panel type 03-->
                <?php echo $this->element('panel_group',array('datas'=>array('panel_3'),'css'=>'panel_3')); ?>
                <input type="hidden" id="address_choose" value=<?php echo $address_choose; ?> >
            </div>
            <div class="clear"></div>
