...
<div class="tab_1 half_width" style="width:45%;margin:5% auto;">
        ...
        <form id="form_salesinvoices" method="POST">
        ...
        <span class="title_block bo_ra2">
            ...
            <input type="hidden" name="highest" value="true" />
    ...
    $(function(){
        ...
        $('#ContinueButton').click(function(){
            ...
            else
            {
                ...
                $.ajax({
                    url: '<?php echo URL; ?>/salesinvoices/check_exist_customer/amount',
                    type: 'POST',
