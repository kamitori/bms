<div class="logo float_left">
    ...
    <div class="title_top_ctrl float_left">
        ...
        <span>Record <?php if(isset($entry_menu['page'])) echo $entry_menu['page']; else echo '0';?> of <?php if(isset($entry_menu['total'])) echo $entry_menu['total']; else echo '0';?>. Total <?php if(isset($entry_menu['total'])) echo $entry_menu['total']; else echo '0';?></span>
    </div>
</div>