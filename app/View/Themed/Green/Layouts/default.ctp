...
<head>
	...
	<?php
		echo $this->Minify->css(array('reset','style','jt_screen','jt_vunguyen','/theme/green/css/jobtraq_chat','jquery-ui-1.10.3.custom.min','kendo/kendo.common.min','kendo/kendo.anvy.min','jquery.mCustomScrollbar'));
