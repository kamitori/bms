...
<div class="tab_1 half_width" style="width:40%;margin:0 auto;">
        ...
        <form id="product_find" method="POST">
        <div class="tab_2_inner">
            ...
            <p class="clear">
                ...
                <div class="indent_new width_in float_left" style="width:61%">
                    <input name="sell_price" class="input_4 float_left validate" type="text" id="sell_price">                              
                </div>
            <p></p>
            <p class="clear"></p>
        </div>
    ...
    $(function(){
        ...
        $('#ContinueButton').click(function(){
            ...
            else
            {
                ...
                $.ajax({
                    url: '<?php echo URL; ?>/quotations/check_exist_product',
                    type: 'POST',
                    data: {data : $('#product_find').serialize()},
                    async: false,
