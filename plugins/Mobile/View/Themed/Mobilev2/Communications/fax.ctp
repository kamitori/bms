<form class="<?php echo $controller; ?>_form_auto_save" id="form_communication_<?php echo $this->data['Communication']['_id']; ?>">
	...
	<div class="ui-field-contain">
        <label class="field-title" for="RefCode"><?php echo __('Ref code'); ?></label>
    ...
    <div class="ui-field-contain">
        ...
        <?php
                ...
                echo $this->Form->input('Communication.company_id', array(
                    'type'=>'hidden'
                ));
        ?>
    </div>
    ...
    <div class="ui-field-contain">
        <label class="field-title" for="CommunicationFirstName"><?php echo __('First name'); ?></label>
        <?php
                echo $this->Form->input('Communication.our_rep', array(
                        'readonly' => true,
                        'class' => 'popup-input',
                        'data-popup-controller' => 'contacts',
                        'data-popup-key' => 'our_rep'
                ));
                echo $this->Form->input('Communication.our_rep_id', array(
                    'type'=>'hidden'
                ));
        ?>
    </div>
    <div class="ui-field-contain">
        <label class="field-title" for="CommunicationCommsDate"><?php echo __('Comms Date'); ?></label>
        <div>
        ...
        <div data-role="collapsible">
            ...
            <ul data-role="listview" data-theme="a">
                ...
                <li>
                    ...
                    <div class="ui-block-b" style="width:70%">
                        <?php echo $this->Form->input('Communication.contact_address.0.contact_country_id', array(
