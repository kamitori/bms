...
<div class="ui-field-contain">
    <label class="field-title" for="company_name"><?php echo __('Customer'); ?></label>
    <input class="unselectable"  id="company_name" type="text" value="<?php echo $arr_data['company_name']; ?>" readonly />
</div>
<div class="ui-field-contain">
...
$(function(){
    $("#delete-record").text("Return").attr("href","<?php echo M_URL.'/companies/products' ?>");
    $("#delete_button").click(function(){
        ...
        saveOption({opname : "pricing", key : "<?php echo $pricing_key; ?>", data : data, controller : "companies", callBack : function(){
    ...
    $("#notes").change(function(){
        ...
        saveOption({opname : "pricing", key : "<?php echo $pricing_key; ?>", data : data, controller : "companies"});
    });
