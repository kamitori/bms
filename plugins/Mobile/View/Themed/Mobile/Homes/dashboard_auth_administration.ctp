	...
	<div class="width_dash float_left">
		<div class="tab_1 full_width block_dent8">
				...
				<span class="float_right">
					...
					<span class="block_sear bl_t">
						...
						<div class="box_inner_search float_left" style="width: 95px;">
							...
							<?php echo $this->Form->input('Job.contact', array(
									'class' => 'input_select input-search-listbox',
									'onchange' => 'job_update_data()',
									'readonly' => true
							)); ?>
			...
			<ul class="ul_mag clear bg">
				...
				<li class="hg_padd center_txt no_border" style="width:14.6%">Late</li>
			</ul>
				...
				<span class="float_right">
					...
					<span class="block_sear bl_t">
						...
						<div class="box_inner_search float_left" style="width: 95px;">
							...
							<input name="data[Quotation][our_rep]" class="input_select input-search-listbox" onchange="quotation_update_data()" readonly="readonly" type="text" id="QuotationOurRep">
				...
				<span class="float_right">
					...
					<span class="block_sear bl_t">
						...
						<div class="box_inner_search float_left" style="width: 95px;">
							...
							<input name="data[Purchaseorder][our_rep]" class="input_select input-search-listbox" onchange="purchaseorder_update_data()" readonly="readonly" type="text" id="PurchaseorderOurRep">
		...
		<div class="tab_1 full_width block_dent8">
				...
				<span class="float_right">
					...
					<span class="block_sear bl_t">
						...
						<div class="box_inner_search float_left" style="width: 95px;">
							...
							<input name="data[Shipping][our_rep]" class="input_select input-search-listbox" onchange="shipping_update_data()" readonly="readonly" type="text" id="ShippingOurRep">
			...
			<ul class="ul_mag clear bg">
			 ...
			 <input type="hidden" id="shipping_type">
				...
				<li class="hg_padd center_txt no_border" style="width:72%">
					<label>Company</label>
				...
				<span class="float_right">
					...
					<span class="block_sear bl_t">
						...
						<div class="box_inner_search float_left" style="width: 95px;">
							...
							<input name="data[Salesinvoice][our_rep]" class="input_select input-search-listbox" onchange="salesinvoice_update_data()" readonly="readonly" type="text" id="SalesinvoiceOurRep">
