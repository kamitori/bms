...
<div class="tab_1 half_width" style="width:40%;margin:0 auto;">
        ...
        <form id="product_find" action="<?php echo URL;?>/purchaseorders/product_report/category_detailed" method="POST">
        <div class="tab_2_inner">
            ...
            <p class="clear">
                ...
                <div class="width_in float_left indent_input_tp" style="width:61.5%">
                    ...
                    <script type="text/javascript">
                        $(function () {
                            $("#status").combobox(<?php echo json_encode($arr_data['purchaseorders_status']); ?>);
                        });
                    </script>
                </div>
            <p></p>
...
<script type="text/javascript">
    $(function(){
        ...
        $('#CancelButton').click(function(){
            window.location.replace('<?php echo URL; ?>/purchaseorders/options');
        });
        $('#ContinueButton').click(function(){
            if(check_Empty())
                ...
                $.ajax({
                    url: '<?php echo URL; ?>/purchaseorders/product_report/category_detailed',
                    type: 'POST',
    ...
    function after_choose_products(_id,product_name,keys){
        ...
        $('#'+keys+'_id').val(_id);
        $.get('<?php echo URL; ?>/purchaseorders/get_cate_product/'+product_info.category,function(result) {
            //console.log(result);
            $('#category').val(result);
        });
