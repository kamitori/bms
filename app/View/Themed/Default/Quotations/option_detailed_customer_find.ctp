...
<div class="tab_1 half_width" style="width:45%;margin:5% auto;">
        ...
        <form id="form_quotation" action="<?php echo URL;?>/quotations/customer_report/<?php echo $report_type ?>" method="POST">
    ...
    $(function(){
        ...
        $('#ContinueButton').click(function(){
            if(check_Empty()){
                ...
                $.ajax({
                    url: '<?php echo URL; ?>/quotations/customer_report/<?php echo $report_type ?>',
                    type: 'POST',
                    data:  $('input','#form_quotation').serialize(),
