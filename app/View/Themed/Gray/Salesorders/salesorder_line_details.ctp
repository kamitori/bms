...
<div class="tab_1" style="width:<?php echo $w;?>; float:left;">
    <span class="title_block bo_ra1">
        <span class="float_left">
            <span class="fl_dent"><h4>Sales order line details</h4></span>
        </span>
    </span>
    <div class="tab_2_inner">
    	<?php foreach($arr_subsetting[$salesorderline] as $kk=>$vv){?>
        <p class="clear">
            <span class="label_1 float_left minw_lab2"><?php echo $vv;?></span>
            <div class="width_in3a float_left indent_input_tp">
                <input class="input_1 float_left" type="text" value="<?php if(isset($subdatas[$salesorderline][$kk])) echo $subdatas[$salesorderline][$kk];?>" readonly="readonly" style="color:#888;" />
            </div>
        </p>
        <?php $lines++; }?>
        ...
        <input type="hidden" id="salesorder_code" value="<?php if(isset($salesorder_code)) echo $salesorder_code;?>" />
