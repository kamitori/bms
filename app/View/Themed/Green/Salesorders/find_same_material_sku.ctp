...
<div class="tab_1 half_width" style="width:40%;margin:6% auto;">
    ...
    <form id="product_find" action="<?php echo URL;?>/salesorders/same_material_report" method="POST">
        <div class="tab_2_inner">
            ...
            <div class="indent_new width_in float_left" style="width:61%">
                <input name="product_sku" class="input_4 float_left validate" type="text" id="product_sku">
            </div>
            <p></p>
            <p></p>
            <p class="clear">
            ...
            <div class="indent_new width_in float_left" style="width:61%">
                <input name="product_name" class="input_4 float_left validate" type="text" id="product_name">
            </div>
            <p></p>
            <p class="clear">
                <span class="label_1 float_left minw_lab2">
            ...
            <div class="indent_new width_in float_left" style="width:61%">
                ...
                <script type="text/javascript">
                    $(function(){
                        window_popup('contacts', 'Specify Our rep','our_rep','click_open_window_contactsour_rep', '?is_employee=1');
                    });
                </script>
            </div>
            <p></p>
            ...
            <?php echo $this->Form->input('date_to', array(
                'class' => 'input_4 float_left jt_input_search JtSelectDate',
                'readonly' => true,
                'name'=>'date_to',
...
<script type="text/javascript">
    $(function() {
        ...
        $('#CancelButton').click(function() {
            window.location.replace('<?php echo URL; ?>/salesorders/options');
        });
        $('#ContinueButton').click(function() {
            if (check_Empty())
                ...
                $.ajax({
                    url: '<?php echo URL; ?>/salesorders/same_material_report',
                    type: 'POST',
    ...
    function popup_init(force_re_install) {
    ...
    function after_choose_products(_id, product_name, keys) {
        ...
        $('#product_code').val(function() {
            var value = $(this).val();
            if (value.length) {
                value += '; ';
            }
            return value += product_info.code;
        });
        $('#product_name').val(function() {
            var value = $(this).val();
            if (value.length) {
                value += '; ';
            }
            return value += product_info.name;
        });
        $('#product_sku').val(function() {
            var value = $(this).val();
            if (value.length) {
                value += '; ';
            }
            return value += product_info.sku;
        });
