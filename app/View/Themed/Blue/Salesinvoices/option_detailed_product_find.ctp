...
<div class="tab_1 half_width" style="width:40%;margin:0 auto;">
        ...
        <form id="product_find" action="<?php echo URL;?>/salesinvoices/product_report/detailed" method="POST">
        ...
        <div>
        <input type="hidden" name="report_type" id="report_type" value="detailed" />
    ...
    $(function(){
        ...
        $('#ContinueButton').click(function(){
            if(check_Empty())
                ...
                $.ajax({
                    url: '<?php echo URL; ?>/salesinvoices/product_report',
                    type: 'POST',
